...
from .datasets import df_pays_covid
...
def affiche_page_intro():
    ...
    """ # ça fait moche lol
    st.write(
    "Les fonctionnalités les plus intéressantes de Streamlit sont :")
    st.write(
    "- Créer des applications web en quelques lignes de code,")
    st.write(
    "- Créer des applications web interactives,")
    st.write(
    "- Créer des applications web avec des cartes interactives.")
    """
    ...
    st.write(
        "La carte ci-dessus montre les cas totaux de COVID-19 en Europe : \
        plus le pays est en bleu foncé, plus il a de cas. Et les pays gris \
        sont ceux qui n'ont pas de données."
    )
